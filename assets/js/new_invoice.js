  ...
  if (data) {
    ...
    $.each(data, function (index, value) {
      if (pt.includes(value.id)) {
        $("#id_invoicebody").append('<tr><td></td><td>' + value.item + '</td>                                                               <td>' + value.description + '</td>                                                                                                  <td>' + value.qty + '</td>                                                                                                          <td>' + setuom(value.uom_id) + '</td>                                                                                                   <td>' + humanamount(value.unit_price) + '</td>                                                                                      <td>' + humanamount(value.total) + '</td>                                                                                               <td class="py-0 align-center" style="vertical-align: middle;">                                                                        <button class="btn btn-default btn-sm pdf" data-href="' + baseUrl + 'pdf/invoice_' + iv[pt.indexOf(value.id)] + '.pdf" type="button">View Invoice</button></td></tr>');
