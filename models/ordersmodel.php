...
class OrdersModel extends Model
{
    ...
    {
        $sql = "select o.id as order_id, o.customer_id, bill_to as bill_id , ship_to as ship_id, c.name as customer,c.cnt_code, g.id as group_id, g.name as customer_group, c.contact_person, o.order_date, ot.title as order_type,
    ...
    public function getOrderViewSummary($orderId)
    {
        ...
        sum(p.allocated_amt) as received_amt, o.ordertotal - sum(p.allocated_amt) - sum(p.tds_deducted) as balance_amt,sum(p.tds_deducted) AS tds_deducted
        from orders as o
