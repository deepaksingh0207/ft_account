<?php
  ...
  function cmsHeader()
  {
      ...
      echo '<title>ZTDMS - Web Installer</title>' . "\n";
      echo '<link rel="stylesheet" type="text/css" href="style.css?'.time().'">' . "\n";
      echo '<link rel="stylesheet" type="text/css" href="../assets/css/jquery-confirm.css">' . "\n";
      echo '<script type="text/javascript" src="../assets/js/jquery.js"></script>' . "\n";
      echo '<script type="text/javascript" src="../assets/js/jquery.validate.js"></script>' . "\n";
      echo '<script type="text/javascript" src="../assets/js/jquery-confirm.min.js"></script>' . "\n";
      echo '<script type="text/javascript" src="../assets/js/setup.js?'.time().'"></script>' . "\n";
      echo '</head>' . "\n";
      echo '<body>' . "\n";
	  echo '<div id="wrap">' . "\n";
	  echo '<header class="clearfix"><img src="../assets/img/ftpsl-logo.png" alt="W">Welcome to ZTDMS Install Wizard</header>' . "\n";
