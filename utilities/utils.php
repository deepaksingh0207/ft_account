...
class Utils {
   ...
   $get_paise = ($amount_after_decimal > 0) ? " and " . ($change_words[round($amount_after_decimal / 10) * 10] . " " . $change_words[$amount_after_decimal % 10]) ." ". CURRENCY_FRAC[$currency]['fraction'] : '';
