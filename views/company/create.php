                ...
                <div class="card card-default">
                  ...
                  <div class="card-body p-3">
                    ...
                    <div class="row mx-1">
                      ...
                      <div class="col-sm-12 col-lg-3 form-group numberonly">
                        <input type="tel" class="form-control fc ftsm" name="mobile" id="id_mobile"
                          pattern="[9,8,7,6]{1}[0-9]{9}" minlength="10" maxlength="10" value="" />
                      </div>
                    </div>
                    ...
                    <div class="row mx-1">
                      ...
                      <div class="col-sm-12 col-lg-3 form-group">
                        <input type="text" class="form-control fc ftsm" name="sac" id="id_sac" value="" />
                      </div>
                    </div>
                    ...
                    <div class="row mx-1">
                      ...
                      <div class="col-sm-12 col-lg-3 form-group">
                        <input type="text" class="form-control fc ftsm" name="bank_name" id="id_bank_name" value="" />
                      </div>
                    </div>
                    ...
                    <div class="row mx-1">
                      ...
                      <div class="col-sm-12 col-lg-3 form-group">
                        <input type="text" class="form-control fc ftsm" name="ifsc_code" id="id_isfc_code"
                          maxlength="11" minlength="11" pattern="^[A-Z]{4}[0][A-Z0-9]{6}$" value="" />
                      </div>
                    </div>
