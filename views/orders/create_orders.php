<div class="card card-primary card-outline mb-0 hide" id="add_order_card">
  ...
  <div class="card-body p-0" id="add_order_cardbody">
    <div class="card mb-0" id="add_order_item_card">
      <div class="card-header" id="add_order_item_cardheader">
        <div class="row">
          <div class="col-sm-12 col-md-4 col-lg-4 form-group mb-0">
      ...
      <div class="card-body table-responsive hide p-0" id="add_order_item_cardbody">
    ...
    <div class="card mb-0 mt-3 hide" id="payment_term_card">
      <div class="card-header" id="payment_term_cardheader"><b>Payment Term</b></div>
      <div class="card-body" id="payment_term_cardbody"></div>
    </div>
  </div>

  <div class="card-footer text-right" id="add_order_cardfooter">
    <button type="button" class="btn btn-primary btn-sm showmain_card" value="1">
      Save Order Item
    </button>
