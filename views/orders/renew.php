                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
                        <b>Customer PO No. :</b><?php echo $order['po_no'] ?>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
                        <b>Customer : </b><?php echo $order['customer'] ?>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
                        <b>Contact Person : </b><?php echo $order['contact_person'] ?>
                      </div>
                      <div class="col-sm-12 col-md-12 col-lg-12 mb-2">
                        <b>Bill To : </b><?php echo $order['bill_to'] ?>
                      </div>
                      <div class="col-sm-12 col-md-12 col-lg-12 mb-2">
                        <b>Ship To : </b><?php echo $order['ship_to'] ?>
                      </div>
                      <input
                        type="hidden"
                        name="currency_code"
                      ...
                      <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
                        <b>Date : </b><?php echo date('d, M Y', strtotime($order['order_date'])) ?>
                      </div>
                      <div class="col-sm-12 col-md-6 col-lg-6 mb-2">
                        <b>Attachment : </b><?php echo $order['attachment'] ?>
                      </div>
                                    ...
                                    <tr id="orderitem_1_paymentterm_1">
                                      ...
                                      <td
                                        ...
                                        <input
                                          ...
                                          id="orderitem_1_paymentterm_1_val_6" /><span
                                          id="orderitem_1_paymentterm_1_txt_6">0.00</span>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
