                ...
                <ul class="list-group list-group-flush">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 col-md-8 mt-2">
                        <div
                          ...
                          style="
                            background-image: url(<?php echo ROOT ?>assets/img/bee.png);
                  ...
                  <li class="list-group-item text-right">
                    <button
                      type="submit"
                      id="submit_id"
                      class="btn btn-lg btn-light mr-4"
                    >
                    ...
                    <button
                      type="reset"
                      id="cancel"
                      class="btn btn-lg btn-secondary align-vert"
                    >
